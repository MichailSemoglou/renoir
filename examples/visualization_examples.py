...
def example_2_style_bar_chart():
    """Create a bar chart of style distribution for Picasso."""
    print("\n" + "=" * 60)
    print("Example 2: Style Distribution Bar Chart")
    print("=" * 60)
...
def example_5_save_visualizations():
    ...
    analyzer.plot_genre_distribution(
        "pierre-auguste-renoir", save_path="renoir_genres.png"
    )

    print("Creating and saving comprehensive overview...")
    analyzer.create_artist_overview("claude-monet", save_path="monet_overview.png")
